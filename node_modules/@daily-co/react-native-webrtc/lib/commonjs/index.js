...
function registerGlobals() {
  ...
  global.navigator.mediaDevices.addEventListener = _MediaDevices.default.addEventListener.bind(_MediaDevices.default);
  global.navigator.mediaDevices.removeEventListener = _MediaDevices.default.removeEventListener.bind(_MediaDevices.default);
  _MediaDevices.default.addEventListener('devicechange', () => {
