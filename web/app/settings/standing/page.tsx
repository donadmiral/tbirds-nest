  ...
  return (
    <div className="mx-auto max-w-[560px] px-1">
      ...
      {rows === null ? <p className="py-10 text-center text-sm text-ink/40">Loading</p> : (
        <>
          {restrictionActive ? (
            <div className="mb-5 flex items-center gap-2 rounded-lg border border-amber-300/50 bg-amber-50 p-3">
            ...
            <div className="mb-5 flex items-center gap-2 rounded-lg border border-success/30 bg-success/5 p-3">
          ...
          {rows.map(r => (
            <div key={r.id} className="mb-2 flex items-start gap-3 rounded-lg border border-ink/10 p-3">
