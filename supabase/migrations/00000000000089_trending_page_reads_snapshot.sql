-- 0089 The last mile: the Trending page's posts must be MEMBERS of the
-- engine's snapshot. One source of truth - if the honor math says nothing
-- is trending, the page is empty, and that emptiness is correct.
