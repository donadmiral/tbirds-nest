-- 0124: refine 0123's for_you gate. A post carrying media is content, not
-- advert - it stays in For You with the SOLD veil on its product card. Only
-- media-less posts whose every tagged listing is unavailable drop out.
