-- 0090 One trending truth. The chip on any card, in any feed mode, is now
-- snapshot MEMBERSHIP - the same judge as the page and the rail. And the
-- trending page orders by the engine's exact rank. The word "trending"
-- has one meaning everywhere in the app.
