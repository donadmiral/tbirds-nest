-- 0085 Trending gets a quality floor: a post needs at least 3 engagements to
-- appear on the page at all. Tiny numbers no longer fill the leaderboard;
-- the badge-first ordering from 0084 is preserved.
