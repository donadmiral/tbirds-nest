...
const s = themedSheet((t) => ({
  container: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24, backgroundColor: t.surface.canvas },
  ...
  buttonText: { color: t.ink.inverse, fontSize: 15, fontWeight: '600' },
}));