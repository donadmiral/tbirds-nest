...
function parseDualLayout(raw: any): ParsedDualLayout | null {
  ...
  const nx = typeof bubble.nx === 'number' ? bubble.nx : null;
  const ny = typeof bubble.ny === 'number' ? bubble.ny : null;
