  ...
  return (
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      >
        ...
        {/* Primary CTAs */}
        <View style={s.ctaRow}>
          <TouchableOpacity style={[s.ctaCard, s.ctaFind]} onPress={() => nav.navigate('MentorList')} activeOpacity={0.85}>
          ...
          <TouchableOpacity
            ...
            onPress={() => nav.navigate('BecomeMentor')}
            activeOpacity={0.85}
          >
          ...
          <View style={s.section}>
            ...
            {incoming.slice(0, 3).map(r => (
              <TouchableOpacity
                ...
                style={s.reqRow}
                activeOpacity={0.7}
                onPress={() => nav.navigate('MentorshipRequests')}
              >
                {r.avatar_url ? (
            ...
            {incoming.length > 3 && (
              <TouchableOpacity style={s.viewMoreBtn} onPress={() => nav.navigate('MentorshipRequests')}>
          ...
          {mentorships.length === 0 ? (
            ...
            mentorships.map(m => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                onPress={() => nav.navigate('MentorshipDetail', { mentorshipId: m.mentorship_id })}
              >
                {m.partner_avatar ? (
        ...
        {/* Outgoing pending requests (mentee view) */}
        {outgoing.length > 0 && (
          <View style={s.section}>
