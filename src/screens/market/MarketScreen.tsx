...
const s = StyleSheet.create({
  ...
  card: { width: CARD_W },
  cardImg: { width: CARD_W, height: CARD_W, borderRadius: 12, backgroundColor: GRAY_100 },
  cardImgEmpty: { alignItems: 'center', justifyContent: 'center' },
  cardBody: { paddingTop: 8, paddingHorizontal: 2 },
  cardPrice: { fontSize: 15, fontWeight: '800', color: GRAY_900 },
  cardTitle: { fontSize: 13, color: GRAY_900, marginTop: 1 },
  cardMetaRow: { flexDirection: 'row', alignItems: 'center', marginTop: 2 },
  cardMeta: { fontSize: 12, color: GRAY_500, flex: 1 },
